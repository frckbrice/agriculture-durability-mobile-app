...
export const useProjectInspectionDataStore = create<IProjectData>()(
    persist(
        (set, get) => ({
            getProjectsData: () => {
        ...
        {
            name: 'project-data-store-inspection',
...
export const useAutoEvaluationDataStore = create<IProjectData>()(
    persist(
        (set, get) => ({
            getProjectsData: () => {
                return get().projectsData ?? [];
        ...
        {
            name: 'project-data-store-autoevaluation',
            storage: createJSONStorage(() => zustandStorage),
        }
    )
)
