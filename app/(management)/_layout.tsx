...
const TabsLayout = () => {
    ...
    return (
        <>
                ...
                screenOptions={{
                    ...
                    headerTitle: () => (
                        <View className='ml-16'>
                            <Image source={require('@/assets/images/logo_forest.png')} resizeMode='contain' className='w-24 h-24' />
                        </View>
                    ),
            ...
            <StatusBar style="light" networkActivityIndicatorVisible backgroundColor='#111' />
        </>
    )
}
