...
export default function InpectionLayout() {
        ...
        >
            <MaterialTopTabs.Screen name="index" options={{
                ...
                listeners={{
                    focus: () => {
                        // Add focus handling
                        console.log('Inspections tab focused');
                    }
                }} />
            {/* <MaterialTopTabs.Screen name="[project_id]" options={{ title: 'Inspection-form' }} /> */}
            <MaterialTopTabs.Screen name="drafted-project" options={{
                title: 'Drafts',
                lazy: true
            }} />
            <MaterialTopTabs.Screen name="sent-projects" options={{
                title: 'Uploaded',
                lazy: true
            }} />
        </MaterialTopTabs>
